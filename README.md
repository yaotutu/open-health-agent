...
<table>
  <tr>
    <td align="center"><b>饮食记录 + 主动关怀</b></td>
    <td align="center"><b>慢性病关联分析</b></td>
    <td align="center"><b>综合健康周报</b></td>
  </tr>
  <tr>
    <td><img src="docs/screenshots/diet-recording-and-care.jpg" width="250"/></td>
    <td><img src="docs/screenshots/chronic-condition-allergy.jpg" width="250"/></td>
    <td><img src="docs/screenshots/weekly-summary.jpg" width="250"/></td>
  </tr>
  <tr>
    <td align="center">说一句「中午吃了排骨饭」<br>AI 记录热量并给出晚餐建议<br>还会主动推送午间关怀</td>
    <td align="center">「鼻子不舒服」<br>AI 关联过敏性鼻炎病史 + 眼睛干涩症状<br>结合春季花粉给出针对性建议</td>
    <td align="center">综合体重、运动、睡眠、饮食、症状<br>AI 自动生成周报<br>发现睡眠是最大短板</td>
  </tr>
</table>
...
- **语言**: TypeScript
- **LLM**: 多模型支持（通过 [pi-ai](https://github.com/mariozechner/pi-ai)，支持 Anthropic / OpenAI / 智谱 / Google / Mistral 等）
...
> 只需设置 `LLM_PROVIDER` + `LLM_MODEL` + 对应的 API Key 环境变量，即可使用。提供商通过 [pi-ai](https://github.com/mariozechner/pi-ai) 统一适配。
>
...
| [pure-wechatbot](https://github.com/yaotutu/pure-wechatbot) | 微信 iLink Bot 协议客户端 |
