...
--> statement-breakpoint
CREATE INDEX `idx_channel_binding_user_id` ON `channel_bindings` (`user_id`);--> statement-breakpoint
...
CREATE TABLE `cron_jobs` (
	...
	`deliver` integer DEFAULT true NOT NULL,
	`channel` text,
...
--> statement-breakpoint
CREATE INDEX `idx_cron_jobs_user_id` ON `cron_jobs` (`user_id`);--> statement-breakpoint
